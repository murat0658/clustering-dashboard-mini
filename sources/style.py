...
dropdown_style = {'font-size': '13px', 'color' : 'white', 'white-space': 'nowrap', 'text-overflow': 'ellipsis', 'backgroundColor': corporate_colors['dark-green']}
...
corporate_layout = go.Layout(
    font = {'family' : corporate_font_family, 'size': 15},
